...
# Capítulo 2: Hardware de robot humanoide y sistemas de actuadores

## Objetivos de aprendizaje

Al final de este capítulo, usted:
- Comprender la estructura mecánica de los robots humanoides
- Aprender sobre diferentes tecnologías de actuadores
- Explorar los sistemas de sensores para la percepción y la propiocepción
- Analizar la potencia y los sistemas de gestión de la energía

## Estructura mecánica del robot humanoide

Los robots humanoides están diseñados para imitar el factor de forma humana, por lo general con:```mermaid
graph TB
...
graph LR
    ...
    C --> E[Force Sensor]
```** Beneficios clave **:
- Control de fuerza a través de la medición de la desviación del resorte
- Tolerancia al impacto y seguridad
- Almacenamiento de energía para una locomoción eficiente
...
Mida la posición y la velocidad de la articulación:```python
...
Proporciona aceleración y velocidad angular:```python
import numpy as np
...
```#### 3. Sensores de fuerza/par

Mida las fuerzas de interacción en las juntas o los efectores finales:```yaml
Sensor: ATI Mini40
Force Range:
  - Fx, Fy: ±40 N
  - Fz: ±120 N
...
Sensores que perciben el entorno externo:

#### Cámaras

- ** Cámaras RGB **: Percepción del color, reconocimiento de objetos
- ** Cámaras de profundidad **: Intel RealSense, Azure Kinect
- ** Cámaras estéreo **: profundidad de la disparidad

#### LiDAR

Generación de nubes de puntos 3D para mapeo y detección de obstáculos:```python
class LiDARPoint:
    """Single LiDAR point"""
...
Los robots humanoides modernos suelen utilizar:

**Litio-Ion (Li-ion)**:
- Densidad energética: 150-250 Wh/kg
- Tensión: 3,6-3,7V por celda
- Vida útil del ciclo: 500-1000 ciclos

**Ejemplo de paquete de baterías **:```yaml
...
```### Distribución de energía```mermaid
graph TD
